...
REQUIRED_MIGRATIONS = 95  # bump each time a new migration is applied; 0041 (macro_thesis_learning_loop, applied 2026-07-24) — observed count from supabase_migrations.schema_migrations
