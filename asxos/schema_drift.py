...
EXPECTED_UNAPPLIED: dict[str, str] = {
    ...
    "outcome_materialisation": (
        "0052 — drafted on campaign node H7-A; applied under James's 2026-09-02 "
        "I5 grant once the branch is green, and this entry removed in the same PR"
    ),
