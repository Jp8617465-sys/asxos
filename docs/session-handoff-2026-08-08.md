...
| Gate0 control hardening | `agent/arbi-authority-gate0@eeed24019edf` | Recorded `CODE_READY / MCP_CANARY_PENDING / NO AUTHORITY INCREASE` against the PR #72 base. It now requires exact rebase/extraction and reverification against post-PR74 main. |
