...
2. `session-handoff-2026-08-11.md` — the newest dated handoff and current priority state; it separates shipped evidence, branch-only work, and unratified future-state recommendations
