...
| 2026-08-22 | `dream-candidates/2026-08-17-dream.md`, `2026-08-18-dream.md`, `2026-08-22-dream.md` (all → `archive/`) | L27–L45 + amendments to L11/L17/L19/L22/L23/L26 | none new (RC5–RC8 stand); 18.4 routed to lessons not project-facts | fresh-context grader (this promote) + `security-engineer` second review on 17.2/17.6/17.10/17.12/22.1/22.2 (PROMOTE-WITH-AMENDMENT; four BLOCK unamended) | `rubrics/arbi-dream-promotion.md` — completed:true ✓ ×3, improve-one ✓, regress-none ✓ after amendments; holdout evals + episode_score trend NOT RUN | promoted (partial fold: 17.3/17.4/17.8/17.10/17.11/18.5/18.6 as amendments) — James's merge of the promotion PR = the promotion |
