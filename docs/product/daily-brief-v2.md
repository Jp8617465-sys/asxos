...
| **1** | BLUF reorder / inverted pyramid; delta-oriented "what changed"; linked static detail page. | No |
| **2** | Gold section artefacts (migrations); composer becomes read-and-assemble; optional pool as *interim* only. | No — I5/I6: no migrations in this agent |
