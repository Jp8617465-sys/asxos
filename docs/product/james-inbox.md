...
**Last verified:** 2026-08-19 (the Cursor-session product rulings row, appended earlier this
wake, was resolved same-day — James ratified verbatim; see `roadmap-state.md` Amendment F.
The 2026-08-17 dark-launch rows and the three 2026-07 rows are unchanged and remain as the
audit record)
