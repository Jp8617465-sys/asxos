...
|---|---|---|
| **HUBS position — concentration policy (reframed 2026-07-12)** — `conviction_level` NULL (and on all 13 theses, risk R11) | Policy/conviction. **James clarified 2026-07-12:** HUBS is **ESPP** stock (he works at HubSpot), not a chosen pick — *"it should only be a part of the portfolio."* So the open question is **not** a 1–5 conviction rating (arguably the wrong field for comp stock he didn't elect to buy) but a **single-employer concentration-risk** call: what max % of capital is HUBS allowed to be before it's flagged/trimmed. | Either (a) a concentration ceiling for HUBS/employer stock (e.g. "flag above X%"), or (b) if a conviction number is still wanted, James's 1–5. The size-vs-conviction check needs an ESPP/concentration variant — see `docs/proposals/portfolio-team-visibility-2026-07-12.md` §9. Records to `theses.conviction_level` and/or a concentration policy. |
